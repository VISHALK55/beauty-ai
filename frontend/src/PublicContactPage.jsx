    ...
    <div className="min-h-screen bg-[#1c080b] text-white font-sans selection:bg-gold-500/30">
      ...
      <div className="relative w-full py-32 flex flex-col items-start justify-center text-left overflow-hidden px-6 md:px-20">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#1c080b] via-[#110505]/60 to-transparent"></div>
          <div className="absolute inset-0 bg-gradient-to-t from-[#1c080b] via-transparent to-[#1c080b]/50"></div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-20 border-t border-white/5">
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <button className="bg-[#8B0000] hover:bg-[#a50000] text-white font-bold text-xs uppercase tracking-widest px-6 py-3 rounded-full transition-colors flex items-center justify-center gap-2">
                      <Phone size={14} /> CALL NOW
                    </button>
                    <button className="bg-green-800 hover:bg-green-700 text-white font-bold text-xs uppercase tracking-widest px-6 py-3 rounded-full transition-colors border border-green-700 flex items-center justify-center gap-2">
          ...
          <div className="relative">
            ...
            <div className="bg-[#110505] border border-white/10 rounded-2xl p-8 md:p-12 relative z-10 shadow-2xl">
                ...
                <div className="grid md:grid-cols-2 gap-10">
                  ...
                  <div className="relative border-b border-white/20">
                    ...
                    <select className="w-full bg-transparent border-none outline-none text-white py-2 appearance-none cursor-pointer">
                      <option className="bg-[#110505]"></option>
                      <option className="bg-[#110505]">Bridal Makeup Package</option>
                      <option className="bg-[#110505]">Pre-Bridal Treatment</option>
                      <option className="bg-[#110505]">Academy Admission</option>
                      <option className="bg-[#110505]">General Salon Service</option>
                    </select>
                  </div>
                </div>
