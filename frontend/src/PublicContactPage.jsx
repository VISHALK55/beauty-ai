    ...
    <div className="min-h-screen bg-dark-950 text-white font-sans selection:bg-gold-500/30">
      ...
      <div className={`fixed inset-0 bg-dark-950/98 backdrop-blur-md z-[60] transition-all duration-300 ${isMobileMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
        ...
        <div className="p-4 flex flex-col gap-6 text-lg font-bold uppercase tracking-widest text-gray-300">
          ...
          <Link to={`/s/${salon.id}/contact`} className="text-gold-500" onClick={() => setIsMobileMenuOpen(false)}>Contact</Link>`r`n          <Link to="/login" className="text-gold-500 border border-gold-500/50 text-center py-3 rounded-xl mt-4" onClick={() => setIsMobileMenuOpen(false)}>ADMIN LOGIN</Link>
        </div>
      </div>
      ...
      <div className="relative w-full py-32 flex flex-col items-start justify-center text-left overflow-hidden px-6 md:px-20">
        ...
        <div className="relative z-10 max-w-4xl pt-10">
          <div className="text-gold-500 font-bold tracking-[0.3em] text-sm md:text-base mb-4 uppercase">
            REACH OUT
          </div>
          <h1 className="text-6xl md:text-8xl font-serif text-white leading-tight">
            Contact <span className="text-gold-500 italic">Us</span>
          </h1>
        </div>
      </div>

      {/* --- CONTENT & FORM SECTION --- */}
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-20 border-t border-white/5">
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24">
          
          {/* Left Column: Info */}
          <div className="flex flex-col">
            <div className="text-gold-500 font-bold tracking-[0.3em] text-xs mb-4 uppercase">
              ELITE LOUNGE
            </div>
            ...
            <div className="space-y-12">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-white font-bold uppercase tracking-widest text-sm mb-3">Our Address</h4>
              ...
              <div className="flex gap-6">
                <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center shrink-0">
                  <PhoneCall className="text-gold-500" size={20} />
                </div>
                <div>
                  <h4 className="text-white font-bold uppercase tracking-widest text-sm mb-3">Booking & Admissions Support</h4>
                  <p className="text-gray-400 text-lg mb-6">{salon.phone}</p>
                  
                  <div className="flex flex-col sm:flex-row gap-4">
                    <a href={`tel:${salon.phone}`} className="bg-[#8B0000] hover:bg-[#a50000] text-white font-bold text-xs uppercase tracking-widest px-6 py-3 rounded-full transition-colors flex items-center justify-center gap-2">
                      <Phone size={14} /> CALL NOW
                    </a>
                    <a href={`https://wa.me/${salon.phone.replace(/\D/g, '')}?text=Hi%20${encodeURIComponent(salon.name)}!%20I%20would%20like%20to%20book%20a%20consultation.`} target="_blank" rel="noreferrer" className="bg-green-800 hover:bg-green-700 text-white font-bold text-xs uppercase tracking-widest px-6 py-3 rounded-full transition-colors border border-green-700 flex items-center justify-center gap-2">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-white font-bold uppercase tracking-widest text-sm mb-3">Email Inquiries</h4>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-white font-bold uppercase tracking-widest text-sm mb-3">Opening Hours</h4>
                  <p className="text-gray-400 text-sm leading-relaxed">
          ...
          <div className="relative">
            ...
            <div className="bg-dark-950 border border-white/10 rounded-2xl p-8 md:p-12 relative z-10 shadow-2xl">
              <h3 className="text-3xl font-serif text-white mb-10">BOOK YOUR CONSULTATION</h3>
              
              <form className="space-y-10">
                <div className="grid md:grid-cols-2 gap-10">
                  <div className="relative border-b border-white/20">
                    <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest absolute -top-4 left-0">Full Name</label>
                    <input type="text" className="w-full bg-transparent border-none outline-none text-white py-2" />
                  </div>
                  <div className="relative border-b border-white/20">
                    <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest absolute -top-4 left-0">Phone Number</label>
                    <input type="tel" className="w-full bg-transparent border-none outline-none text-white py-2" />
                  </div>
                </div>

                <div className="grid md:grid-cols-2 gap-10">
                  <div className="relative border-b border-white/20">
                    <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest absolute -top-4 left-0">Email Address</label>
                    <input type="email" className="w-full bg-transparent border-none outline-none text-white py-2" />
                  </div>
                  <div className="relative border-b border-white/20">
                    <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest absolute -top-4 left-0">I'm Interested In</label>
                    <select className="w-full bg-transparent border-none outline-none text-white py-2 appearance-none cursor-pointer">
                      <option className="bg-dark-950"></option>
                      <option className="bg-dark-950">Bridal Makeup Package</option>
                      <option className="bg-dark-950">Pre-Bridal Treatment</option>
                      <option className="bg-dark-950">Academy Admission</option>
                      <option className="bg-dark-950">General Salon Service</option>
                    </select>
                  </div>
                </div>

                <div className="relative border-b border-white/20 pt-6">
                  <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest absolute top-2 left-0">Special Notes / Bridal Wedding Date</label>
                  <textarea rows="3" className="w-full bg-transparent border-none outline-none text-white py-2 resize-none mt-2"></textarea>
                </div>
                  ...
                  <label className="flex items-start gap-4 cursor-pointer group">
                    <div className="relative flex items-start justify-center">
                      ...
                      <div className="absolute top-1 pointer-events-none opacity-0 group-has-[:checked]:opacity-100">
                        <svg className="w-3 h-3 text-dark-950" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
                      </div>
                    </div>
                    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-relaxed">
                      I AGREE TO SEND THESE DETAILS THROUGH WHATSAPP AND HAVE READ THE <span className="text-gold-500 border-b border-gold-500/50">PRIVACY POLICY</span>.
                    </span>
                  </label>
                </div>

                <button type="button" className="w-full bg-gradient-to-r from-gold-600 via-gold-400 to-gold-600 text-dark-950 font-bold uppercase tracking-widest text-sm py-4 rounded hover:opacity-90 transition-opacity">
      ...
      <footer className="bg-dark-950 border-t border-white/5 pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">Subscribe to get the latest beauty updates and offers.</p>
