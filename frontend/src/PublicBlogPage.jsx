    ...
    <div className="min-h-screen bg-[#1c080b] text-white font-sans selection:bg-gold-500/30">
      ...
      <div className="relative w-full py-32 flex flex-col items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl px-6 pt-10">
          <div className="text-gold-500 font-bold tracking-[0.3em] text-sm md:text-base mb-6 uppercase">
            INSIGHTS & INSPIRATION
          </div>
          <h1 className="text-5xl md:text-7xl font-serif text-white leading-tight">
            Beauty & Cosmetology <span className="text-gold-500 italic">Journal</span>
          </h1>
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 pb-24">
        <div className="mb-10 text-gray-400 text-sm">
          Showing <strong className="text-gold-500">673</strong> matches for your search selection.
        </div>
            ...
            <div key={idx} className="bg-[#150608] border border-white/5 flex flex-col group hover:border-gold-500/30 transition-colors overflow-hidden">
              ...
              <div className="p-8 flex flex-col flex-grow">
                ...
                <div className="flex justify-between items-center mb-6">
                  <span className="border border-gold-500/30 text-gold-500 text-[10px] font-bold uppercase tracking-widest px-3 py-1 rounded-full">
                    {blog.category}
                  </span>
                ...
                <div className="mt-auto pt-4 flex items-center">
                  <span className="text-gold-500 font-bold text-xs uppercase tracking-widest flex items-center gap-2 cursor-pointer group-hover:text-white transition-colors">
