...
import { Sparkles, MapPin, Phone, Star, Heart, Calendar, ChevronRight, Camera, Link } from 'lucide-react';
...
export default function LandingPage() {
    ...
    const categories = ['All', 'Makeup & Bridal', 'Hair', 'Skin & Body', 'Brows & Lashes', 'Nails'];
        ...
        <div className="bg-[#FAF9F6] font-sans selection:bg-[#E8B5A2]/30 text-gray-800">
            ...
            <div className="relative h-[80vh] md:h-[90vh] bg-zinc-900 overflow-hidden flex items-center justify-center">
                ...
                <div className="relative z-20 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
                    <div className="inline-flex items-center space-x-2 border border-[#E8B5A2]/50 px-5 py-2 rounded-full mb-8 backdrop-blur-sm bg-black/20">
                        ...
                        <span className="text-[#E8B5A2] text-xs md:text-sm font-medium tracking-[0.2em] uppercase">Bodhgaya / Gaya's Premier Makeup Studio</span>
                    </div>
                    <h1 className="text-5xl md:text-8xl font-light text-white mb-6 font-serif tracking-tight">Pihu Makeover</h1>
                    <p className="text-lg md:text-2xl text-gray-300 font-light mb-10 max-w-2xl leading-relaxed">
                        Elevating bridal beauty with flawless precision, luxury treatments, and unforgettable transformations.
                    </p>
            ...
            <div className="bg-[#2A2A2A] py-6 px-4 text-[#E8B5A2]">
                <div className="max-w-6xl mx-auto flex flex-wrap justify-center md:justify-between items-center gap-8 text-sm tracking-wider font-light">
                    <div className="flex items-center gap-3">
                        <MapPin size={18} />
                        <span>Sujata Bypass Rd, Bodh Gaya</span>
                    </div>
                    <div className="flex items-center gap-3">
                        <Phone size={18} />
                        <a href="tel:+919113715558" className="hover:text-white transition-colors">+91 91137 15558</a>
                    </div>
                    <div className="flex items-center gap-3">
                        <Star size={18} />
            ...
            <div className="max-w-6xl mx-auto px-4 py-24">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div className="relative">
                        <div className="aspect-[3/4] w-full max-w-md mx-auto bg-gray-200 relative z-10 overflow-hidden shadow-2xl">
                            {/* Placeholder for Owner Photo - replace with owner.jpg when available */}
                            <img 
                                src="/owner.jpg" 
                                alt="Founder of Pihu Makeover" 
                        ...
                        {/* Decorative Box */}
                        <div className="absolute top-8 -left-8 md:-left-12 w-full max-w-md h-full border-2 border-[#E8B5A2] z-0 hidden md:block"></div>
                    </div>
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <p className="text-gray-600 text-lg leading-relaxed mb-6">
                            With years of expertise in HD and Airbrush bridal makeup, our founder has transformed hundreds of brides on their special day. Her philosophy is simple: makeup shouldn't hide you; it should illuminate the most beautiful version of yourself.
                        </p>
                        <p className="text-gray-600 text-lg leading-relaxed mb-8">
                            Trained under top international makeup academies, she brings global trends and flawless techniques right to Bodhgaya, ensuring every client feels like royalty.
                        </p>
                        ...
                        {filteredServices.map(service => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent p-4 md:p-6 flex flex-col justify-end">
                                    <span className="text-[#E8B5A2] text-xs font-bold uppercase tracking-wider mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0">{service.category}</span>
            ...
            <div className="py-24 max-w-7xl mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-500 max-w-2xl mx-auto text-lg">Glimpses of our stunning bridal transformations and studio moments.</p>
                </div>
                
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[1, 2, 3, 4, 5].map((num) => (
                        <div key={num} className="relative group overflow-hidden cursor-pointer" onClick={() => setSelectedService({ id: `gal_${num}`, name: 'Bridal Transformation' })}>
                            <img src={`/gallery/gallery_${num}.jpg`} className="w-full h-80 object-cover group-hover:scale-110 transition-transform duration-700" alt={`Bridal Gallery ${num}`} />
                ...
                <div className="mt-12 text-center">
                    <a href="https://instagram.com" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 border-2 border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-white px-8 py-3 tracking-widest text-sm uppercase font-bold transition-colors">
            ...
            <footer className="bg-zinc-950 text-white pt-20 pb-10 border-t border-white/10">
                <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
                    <div>
                        <h2 className="text-3xl font-serif mb-6">Pihu Makeover</h2>
                        <p className="text-gray-400 leading-relaxed mb-6">
                            Your destination for premium bridal makeup, skin treatments, and luxury hair styling in Bodhgaya.
                        </p>
                        <div className="flex gap-4">
                            <a href="#" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-[#E8B5A2] hover:text-black transition-colors"><Link size={18} /></a>
                            <a href="#" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-[#E8B5A2] hover:text-black transition-colors"><Link size={18} /></a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-4 text-gray-400">
                            <p className="flex items-start gap-3">
                                ...
                                <span>Sujata Bypass Road, near Govt. Middle School, Rajapur Road, Bodh Gaya, Bihar 824231</span>
                            </p>
                ...
                <div className="text-center text-gray-600 text-sm border-t border-white/10 pt-8">
                    &copy; {new Date().getFullYear()} Pihu Makeover Saloon. All rights reserved.
                </div>
            </footer>
