...
public class WhatsAppReviewJob {
    ...
    public void processPendingReviewRequests() {
        ...
        String googleMapsLink = "https://www.google.com/maps/place/Pihu+Makeover/@24.7068881,84.9942657,15z"; 
        ...
        if (hasPendingRequest && geoRankEnabled) {
            ...
            String message = String.format(
                "Hi %s! Thank you for visiting %s today. " +
                "To help our small business grow in Bodhgaya, we would be incredibly grateful if you left us a quick 5-star review here: %s",
                customerName, salonName, googleMapsLink
            );
