...
const Home = () => {
  const schema = {
    ...
    "@type": "BeautySalon",
    "name": "Heena Makeover Beauty Salon",
    "image": "https://Heena.beautyai.makeup/hero-bg.jpg",
    "url": "https://Heena.beautyai.makeup",
    "address": {
      "@type": "PostalAddress",
  ...
  return (
    <>
      <div className="hero">
        <SEO 
          title="Best Bridal Makeup Artist & Academy in Gaya | Heena Makeover" 
          description="Heena Makeover is Gaya's premier destination for high-end bridal makeup, advanced skin aesthetics, and certified professional training by Heena." 
          schema={schema} 
        />
        <div className="hero-content">
          <div className="section-tag">
            <span role="img" aria-label="crown" style={{ marginRight: '8px' }}>👑</span>
            ELITE BRIDAL & ACADEMY | Gaya
          </div>
          <h1 className="section-title">
            Experience <br />
            <span className="italic">Premium</span> <br />
            Luxury in <span className="italic">Gaya</span>
          </h1>
          <p className="section-subtitle">
            Gaya's premier destination for high-end bridal makeup, 
          ...
          <div style={{ 
            ...
            <img 
              src="/owner.jpg" 
              alt="Heena - 15 Years Experience Bridal Artist" 
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.5rem' }}>
                <h3 style={{ fontSize: '1.8rem', color: '#fff', margin: 0 }}>Heena</h3>
              ...
              <p style={{ color: 'var(--color-text-muted)', fontSize: '0.95rem', lineHeight: '1.6', maxWidth: '500px' }}>
                Unlike standard parlours, Heena Makeover is led by an industry veteran. With over 15 years of specialized experience in high-definition bridal transformations and advanced skin aesthetics, Bindu guarantees a luxury, personalized experience that generic salons simply cannot match.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="section container" style={{ padding: '4rem 0', textAlign: 'center' }}>
        <h2 className="section-title" style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>Visit Us in Gaya</h2>
        ...
        <div style={{ width: '100%', height: '400px', borderRadius: '8px', overflow: 'hidden' }}>
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3635.8341604924736!2d84.99169077610667!3d24.70689295328229!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f32dfdf38f62e3%3A0xe61b49ce05b6a398!2sHeena%20Makeover!5e0!3m2!1sen!2sin!4v1709493214812!5m2!1sen!2sin" 
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
            allowFullScreen="" 
